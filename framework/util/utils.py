...
class Config:
    ...
    def __init__(self):
        ...
        if base_dir is None:
            base_dir = os.getcwd()
            print("Warning, PVX_BASE_DIR environment variable is not set. Defaulting it to %s" % (base_dir,))
        self.config_file = base_dir + '/yava.yml'
...
if __name__ == '__main__':
    ...
    retcode = CommandExecutor('aplay -i /home/anon1/Desktop/lincoln.wav').wait()
    print("End", retcode)
