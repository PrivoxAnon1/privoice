...
class PVXMediaPlayerSkill:
    ...
    def __init__(self, bus=None, timeout=5):
        ...
        log_filename = base_dir + '/tmp/logs/media_player.log'
        self.log = LOG(log_filename).log
        self.log.info("Starting PVX MediaPlayer Service")
    ...
    def play_file(self,msg):
        ...
        self.log.info("MediaPlayer: From:%s, MediaType=%s, PlaySID=%s, CurrentSID=%s, play file:%s" % (from_skill, media_type, play_session_id, self.current_session.session_id, file_uri))
...
if __name__ == '__main__':
    pvx_mps = PVXMediaPlayerSkill()
    pvx_mps.is_running = True
    pvx_mps.run()
