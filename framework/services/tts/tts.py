...
class TTSEngine:
    ...
    def _idle_start(self, msg):
        ...
        self.current_session.engine = msg.get('engine', None)
        self.current_session.model = msg.get('model', None)
        self.current_session.voice = msg.get('voice', None)
    ...
    def __init__(self):
        ...
        log_filename = base_dir + '/tmp/logs/tts.log'
